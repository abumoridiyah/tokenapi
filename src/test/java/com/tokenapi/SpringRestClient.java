...
public class SpringRestClient {
    ...
    public static final String REST_SERVICE_URI = "http://localhost:9090/paymentmanager";
    
    public static final String AUTH_SERVER_URI = "http://localhost:9090/paymentmanager/oauth/token";
